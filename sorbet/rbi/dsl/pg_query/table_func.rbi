...
class PgQuery::TableFunc
  ...
  def initialize(colcollations: T.unsafe(nil), coldefexprs: T.unsafe(nil), colexprs: T.unsafe(nil), colnames: T.unsafe(nil), coltypes: T.unsafe(nil), coltypmods: T.unsafe(nil), docexpr: nil, location: nil, notnulls: T.unsafe(nil), ns_names: T.unsafe(nil), ns_uris: T.unsafe(nil), ordinalitycol: nil, rowexpr: nil); end
