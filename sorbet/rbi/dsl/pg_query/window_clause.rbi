...
class PgQuery::WindowClause
  ...
  def initialize(copied_order: nil, end_in_range_func: nil, end_offset: nil, frame_options: nil, in_range_asc: nil, in_range_coll: nil, in_range_nulls_first: nil, name: nil, order_clause: T.unsafe(nil), partition_clause: T.unsafe(nil), refname: nil, run_condition: T.unsafe(nil), start_in_range_func: nil, start_offset: nil, winref: nil); end
