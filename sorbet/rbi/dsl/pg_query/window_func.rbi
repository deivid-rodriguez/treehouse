...
class PgQuery::WindowFunc
  ...
  def initialize(aggfilter: nil, args: T.unsafe(nil), inputcollid: nil, location: nil, winagg: nil, wincollid: nil, winfnoid: nil, winref: nil, winstar: nil, wintype: nil, xpr: nil); end
