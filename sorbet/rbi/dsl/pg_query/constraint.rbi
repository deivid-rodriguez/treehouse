...
class PgQuery::Constraint
  ...
  def initialize(access_method: nil, conname: nil, contype: nil, cooked_expr: nil, deferrable: nil, exclusions: T.unsafe(nil), fk_attrs: T.unsafe(nil), fk_del_action: nil, fk_del_set_cols: T.unsafe(nil), fk_matchtype: nil, fk_upd_action: nil, generated_when: nil, including: T.unsafe(nil), indexname: nil, indexspace: nil, initdeferred: nil, initially_valid: nil, is_no_inherit: nil, keys: T.unsafe(nil), location: nil, nulls_not_distinct: nil, old_conpfeqop: T.unsafe(nil), old_pktable_oid: nil, options: T.unsafe(nil), pk_attrs: T.unsafe(nil), pktable: nil, raw_expr: nil, reset_default_tblspc: nil, skip_validation: nil, where_clause: nil); end
