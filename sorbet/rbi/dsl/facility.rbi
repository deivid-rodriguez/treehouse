...
class Facility
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Facility).void)
      ).returns(T.nilable(T::Enumerator[::Facility]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Facility]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Facility]]))
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Facility` class because it declared `has_many :facility_geocodes`.
    ...
    # This method is created by ActiveRecord on the `Facility` class because it declared `has_many :geocodes, through: :facility_geocodes`.
