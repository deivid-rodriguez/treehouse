...
# source://annotate//lib/annotate/constants.rb#35
...
# source://annotate//lib/annotate/constants.rb#25
Annotate::Constants::OTHER_OPTIONS = T.let(T.unsafe(nil), Array)

# source://annotate//lib/annotate/constants.rb#31
...
module AnnotateModels
  class << self
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#536
    def annotate(klass, file, header, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#730
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#426
    ...
    # source://annotate//lib/annotate/annotate_models.rb#792
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#705
    def do_annotations(options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#726
    def expand_glob_into_files(glob); end

    # source://annotate//lib/annotate/annotate_models.rb#315
    def final_index_string(index, max_size); end

    # source://annotate//lib/annotate/annotate_models.rb#298
    def final_index_string_in_markdown(index); end

    # source://annotate//lib/annotate/annotate_models.rb#384
    def get_check_constraint_info(klass, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#258
    def get_col_type(col); end

    # source://annotate//lib/annotate/annotate_models.rb#348
    def get_foreign_key_info(klass, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#236
    def get_index_info(klass, options = T.unsafe(nil)); end

    # Retrieve loaded model class
    #
    # source://annotate//lib/annotate/annotate_models.rb#659
    def get_loaded_model(model_path, file); end

    # Retrieve loaded model class by path to the file where it's supposed to be defined.
    #
    # source://annotate//lib/annotate/annotate_models.rb#678
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#639
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#588
    ...
    # source://annotate//lib/annotate/annotate_models.rb#225
    def get_schema_footer_text(_klass, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#213
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#138
    def get_schema_info(klass, header, options = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://annotate//lib/annotate/annotate_models.rb#337
    def hide_default?(col_type, options); end

    # @return [Boolean]
    #
    # source://annotate//lib/annotate/annotate_models.rb#326
    def hide_limit?(col_type, options); end

    # source://annotate//lib/annotate/annotate_models.rb#266
    def index_columns_info(index); end

    # source://annotate//lib/annotate/annotate_models.rb#276
    def index_unique_info(index, format = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#289
    def index_using_info(index, format = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#280
    def index_where_info(index, format = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#479
    def magic_comments_as_string(content); end

    # source://annotate//lib/annotate/annotate_models.rb#505
    ...
    #
    # source://annotate//lib/annotate/annotate_models.rb#580
    def options_with_position(options, position_in); end

    # source://annotate//lib/annotate/annotate_models.rb#690
    ...
    # source://annotate//lib/annotate/annotate_models.rb#489
    def remove_annotation_of_file(file_name, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#752
    def remove_annotations(options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_models.rb#785
    ...
    # source://annotate//lib/annotate/annotate_models.rb#696
    def split_model_dir(option_value); end

    private

    # source://annotate//lib/annotate/annotate_models.rb#886
    def columns(klass, options); end

    # source://annotate//lib/annotate/annotate_models.rb#845
    def format_default(col_name, max_size, col_type, bare_type_allowance, simple_formatted_attrs, bare_max_attrs_length = T.unsafe(nil), col_comment = T.unsafe(nil)); end

    # Get the list of attributes that should be included in the annotation for
    # a given column.
    #
    # source://annotate//lib/annotate/annotate_models.rb#936
    def get_attributes(column, column_type, klass, options); end

    # These are the columns that the globalize gem needs to work but
    # are not necessary for the models to be displayed as annotations.
    #
    # source://annotate//lib/annotate/annotate_models.rb#916
    def ignored_translation_table_colums(klass); end

    # source://annotate//lib/annotate/annotate_models.rb#614
    def list_model_files_from_argument; end

    # source://annotate//lib/annotate/annotate_models.rb#873
    def map_col_type_to_ruby_classes(col_type); end

    # source://annotate//lib/annotate/annotate_models.rb#828
    def max_schema_info_width(klass, options); end

    # source://annotate//lib/annotate/annotate_models.rb#859
    def mb_chars_ljust(string, length); end

    # source://annotate//lib/annotate/annotate_models.rb#869
    def non_ascii_length(string); end

    # Add columns managed by the globalize gem if this gem is being used.
    #
    # source://annotate//lib/annotate/annotate_models.rb#904
    def translated_columns(klass); end

    # source://annotate//lib/annotate/annotate_models.rb#855
    def width(string); end

    # @return [Boolean]
    #
    # source://annotate//lib/annotate/annotate_models.rb#816
    def with_comments?(klass, options); end

    # @return [Boolean]
    #
    # source://annotate//lib/annotate/annotate_models.rb#822
    def with_comments_column?(klass, options); end
  end
end

# source://annotate//lib/annotate/annotate_models.rb#983
class AnnotateModels::BadModelFileError < ::LoadError
  # source://annotate//lib/annotate/annotate_models.rb#984
  def to_s; end
end
...
module AnnotateRoutes
  class << self
    ...
    # source://annotate//lib/annotate/annotate_routes.rb#42
    def remove_annotations(options = T.unsafe(nil)); end

    private

    # source://annotate//lib/annotate/annotate_routes.rb#95
    def annotate_routes(header, content, header_position, options = T.unsafe(nil)); end

    # source://annotate//lib/annotate/annotate_routes.rb#84
    def rewrite_contents(existing_text, new_text, frozen); end

    # source://annotate//lib/annotate/annotate_routes.rb#64
    def routes_file; end

    # @return [Boolean]
    #
    # source://annotate//lib/annotate/annotate_routes.rb#60
